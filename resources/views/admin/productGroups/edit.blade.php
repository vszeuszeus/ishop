        ...
        <div class="container containersize1200">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-9 col-lg-10">
                    <a href="{{route('category.show',[$productGroup->category])}}" class="a_back">&lt; Назад к товарам</a>

                    <div class="titlecontent">новая группа</div>
                    <form enctype="multipart/form-data" id="" method="POST" action="{{route('productGroup.update',[$productGroup])}}">
                        {{csrf_field()}}
                        {{method_field('PATCH')}}
                        <div class="row">
                                        ...
                                        <div class="wrap-select block_formitem  selectsizeb">
                                            <select name="category_id" id="" class="select"
                                                ...
                                                @foreach($categories as $category)
                                                    @php $old_category = old('category_id', $productGroup->category_id); @endphp
                                        ...
                                        <div class="col-xs-12 col-md-12 col-lg-6">
                                            <div class="wrap_group_l">
                                                ...
                                                <div class="block_formitem">
                                                    <?php
                                                        $tags = '';
                                                        foreach($productGroup->tags as $tag):
                                                            $tags .= $tag->name.' ';
                                                        endforeach
                                                    ?>
                                            ...
                                            <div class="wrap_group_l">
                                                ...
                                                <div class="block_formitem">
                                                    <input name="price" type="text" class="input_content"
                                                           value="{{old('price', $productGroup->price)}}">
                                                    @if ($errors->has('price'))
                                                        <span class="help-block">
                            ...
                            <div class="col-xs-12 col-md-12 col-lg-6">
                                ...
                                <div class="wrap_group_foto50">
                                    <div class="block_fotoupl">
                                        <div class="img_fotoupl"><img src="{{secure_asset($productGroup->photo_path)}}"
                                                                      alt="{{$productGroup->photo_alt}}"></div>
                                    </div>
                                    <div class="block_fotoupl">
                                ...
                                <div class="wrap_group_in6">
                                    ...
                                    <div class="wr_input_c">
                                        <input name="manager_pay" type="text" class="input_content"
                                               value="{{old('manager_pay' ,$productGroup->manager_pay)}}">
                                    ...
                                    <div class="wrap-select">
                                        <select name="manager_pay_type_id" id="" class="select">
                                            @php $oldPayType = old('manager_pay_type_id', $productGroup->manager_pay_type_id); @endphp
                        ...
                        <div class="wrap_group_input">
                            ...
                            <div class="block_formitem">
                                <textarea name="description" id="" class="textarea_rev  textarea_t2"
                                          placeholder="Введите описание (не менее 500 символов)">{{old('description', $productGroup->description)}}</textarea>
                            ...
                            <div class="col-xs-12 col-md-12 col-lg-5 block_50_lab">
                                ...
                                <div class="wrap_block_table">
                                    <div class="table_cont">
                                        ...
                                        @php $old_managers = old('managers', $productGroup->managers); @endphp
                                        @if($old_managers)
                                            @foreach($managers as $manager)
                                                @php $checkManager = false; @endphp
                                                    @foreach($old_managers as $old_manager)
                                                    @if(is_object($old_manager))
                                                        @if($old_manager->id == $manager->id)
                                ...
                                <div class="wrap_block_table table_type">
                                    <div class="table_cont">
                                        ...
                                        <div class="tabrow">
                                            ...
                                            <div class="tabtd">
                                                <div class="wr_input_type">
                                                    <input @if(old('is_visible_price', $productGroup->is_visible_price)) checked="checked"
                                            ...
                                            <div class="tabtd">
                                                <div class="wr_input_type">
                                                    <input @if(old('is_change_price' ,$productGroup->is_change_price)) checked="checked"
                                        ...
                                        <div class="tabrow">
                                            ...
                                            <div class="tabtd">
                                                <div class="wr_input_type">
                                                    <input @if(old('is_visible_photo', $productGroup->is_visible_photo)) checked="checked"
                                            ...
                                            <div class="tabtd">
                                                <div class="wr_input_type">
                                                    <input @if(old('is_change_photo' ,$productGroup->is_change_photo)) checked="checked"
                                        ...
                                        <div class="tabrow">
                                            ...
                                            <div class="tabtd">
                                                <div class="wr_input_type">
                                                    <input @if(old('is_visible_description', $productGroup->is_visible_description)) checked="checked"
                                            ...
                                            <div class="tabtd">
                                                <div class="wr_input_type">
                                                    <input @if(old('is_change_description', $productGroup->is_change_description)) checked="checked"
                                        ...
                                        <div class="tabrow">
                                            ...
                                            <div class="tabtd">
                                                <div class="wr_input_type">
                                                    <input @if(old('is_visible_tags', $productGroup->is_visible_tags)) checked="checked"
                                            ...
                                            <div class="tabtd">
                                                <div class="wr_input_type">
                                                    <input @if(old('is_change_tags', $productGroup->is_change_tags)) checked="checked"
                        ...
                        <div class="wrap_group_input">
                            ...
                            <div class="block_formitem wr_input_type">
                                <input @if(old('premodaration', $productGroup->premodaration)) checked="checked" @endif name="premodaration"
                        ...
                        <div class="wrap_group_input form_grey">
                            ...
                            <div class="block_formitem">
                                ...
                                <div class="wr_input_cont">
                                    <input name="url" type="text" class="input_content" value="{{old('url', $productGroup->url)}}"
                                           placeholder>
                                    @if ($errors->has('url'))
                                        <span class="help-block">
                            ...
                            <div class="block_formitem">
                                ...
                                <div class="wr_input_cont">
                                    <input name="header_description" type="text" class="input_content"
                                           value="{{old('header_description', $productGroup->header_description)}}" placeholder>
                            ...
                            <div class="block_formitem">
                                ...
                                <div class="wr_input_cont">
                                    <input name="keywords" type="text" class="input_content" value="{{old('keywords', $productGroup->keywords)}}"
                                           placeholder>
                            ...
                            <div class="block_formitem">
                                ...
                                <div class="wr_input_cont">
                                    <input name="title" type="text" class="input_content" value="{{old('title', $productGroup->title)}}"
                                           placeholder>
                                    @if ($errors->has('title'))
                                        <span class="help-block">
                            ...
                            <div class="block_formitem">
                                ...
                                <div class="wr_input_cont">
                                    <input name="h1" type="text" class="input_content" value="{{old('h1', $productGroup->h1)}}"
                                           placeholder>
                                    @if ($errors->has('h1'))
                                        <span class="help-block">
                            ...
                            <div class="block_formitem">
                                ...
                                <div class="wr_input_cont">
                                    <input name="photo_alt" type="text" class="input_content"
                                           value="{{old('photo_alt', $productGroup->photo_alt)}}"
                                           placeholder>
