                                    ...
                                    <div class="wrap-select">
                                        <select name="category_id" id="" class="select">
                                            @foreach($categories as $category)
                                                @php $oldCategory = old('category_id') @endphp
                                                <option @if($oldCategory == $category->id) selected
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-6">
                            ...
                            <div class="wrap_group_in6">
                                ...
                                <div class="wr_input_c">
                                    <input name="manager_pay" type="text" class="input_content" value="{{old('')}}">
                                    ...
                                    <div class="tabtd">
                                        <div class="wr_input_type">
                                            <input @if(old('is_visible_price')) checked="checked"
                                                   @endif name="is_visible_price" type="checkbox" class="input_check">
                                        </div>
                                    </div>
                                    <div class="tabtd">
                                        <div class="wr_input_type">
                                            <input @if(old('is_change_price')) checked="checked"
                                                   @endif name="is_change_price" type="checkbox" class="input_check">
                                        </div>
                                    </div>
                                </div>
                                <div class="tabrow">
                                    ...
                                    <div class="tabtd">
                                        <div class="wr_input_type">
                                            <input @if(old('is_visible_photo')) checked="checked"
                                                   @endif name="is_visible_photo" type="checkbox" class="input_check">
                                        </div>
                                    </div>
                                    <div class="tabtd">
                                        <div class="wr_input_type">
                                            <input @if(old('is_change_photo')) checked="checked"
                                                   @endif name="is_change_photo" type="checkbox" class="input_check">
                                        </div>
                                    </div>
                                </div>
                                <div class="tabrow">
                                    ...
                                    <div class="tabtd">
                                        <div class="wr_input_type">
                                            <input @if(old('is_visible_tags')) checked="checked"
                                                   @endif name="is_visible_tags" type="checkbox" class="input_check">
                                        </div>
                                    </div>
                                    <div class="tabtd">
                                        <div class="wr_input_type">
                                            <input @if(old('is_change_tags')) checked="checked"
                                                   @endif name="is_change_tags" type="checkbox" class="input_check">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="wrap_group_input form_grey">
                        ...
                        <div class="block_formitem">
                            ...
                            <div class="wr_input_cont">
                                <input name="url" type="text" class="input_content" value="{{old('url')}}" placeholder>
                                @if ($errors->has('url'))
                                    <span class="help-block">
                        ...
                        <div class="block_formitem">
                            ...
                            <div class="wr_input_cont">
                                <input name="h1" type="text" class="input_content" value="{{old('h1')}}" placeholder>
                                @if ($errors->has('h1'))
                                    <span class="help-block">
                        ...
                        <div class="block_formitem">
                            ...
                            <div class="wr_input_cont">
                                <input name="photo_alt" type="text" class="input_content" value="{{old('photo_alt')}}"
                                       placeholder>
